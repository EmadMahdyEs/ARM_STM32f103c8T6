...
typedef enum {
	CAN_FILTER_MODE_IDENTIFIER_MASK_MODE_emad,
	CAN_FILTER_MODE_IDENTIFIER_LIST_MODE_emad
} FILTER_MODE_t_emad;

typedef enum {
	CAN_FILTER_SCALE_DUAL_16_BIT_emad,
	CAN_FILTER_SCALE_SINGLE_32_BIT_emad
} FILTER_SCALE_REGISTER_t_emad;
