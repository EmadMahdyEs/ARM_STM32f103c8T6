...
Src/LED_MATRIX_program.o: ../Src/LED_MATRIX_program.c
	arm-none-eabi-gcc "$<" -mcpu=cortex-m3 -std=gnu11 -g3 -DSTM32 -DSTM32F1 -DSTM32F103C8Tx -DDEBUG -c -I../Inc -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -MMD -MP -MF"Src/LED_MATRIX_program.d" -MT"$@" --specs=nano.specs -mfloat-abi=soft -mthumb -o "$@"
